...
local gameLists = {
    FreeVersion = {
        allowedGamesByCreatorId = {
            ...
            [8818124] = {name = "Violence District", url = "https://raw.githubusercontent.com/mabdu21/kjandsaddjadbhahayenajhsjbdwa/refs/heads/main/VII5555555D.lua"},
